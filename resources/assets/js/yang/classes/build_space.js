define([
...
], function (document, trsfm, getStyle, colorCircle, touchPos, findPos, findPos, prefixJs, prefixCss, bindEvent, unbindEvent, requestAnim, cancelAnim, closestPoint, maxPoint, fibonacciSphere, multiplyMatrix3d, calcAngle, calcZ, normalize, crossVector, rotateMatrix) {
    ...
    class BuildSpace {
        ...
        //
        //    var impulse         = true,                     //true有惯性，false没有惯性
        ...
        //    function slide(){
        //
        //        this.rotateObj.style[prefixJs+"Transform"] = "rotate3d("+ axis+", "+angle+"rad) matrix3d("+startMatrix+")";
        //
