define([
	...
	], function(document, trsfm, getStyle, colorCircle, bindEvent, unbindEvent, touchPos, ajax, focus, reveal, conceal, configVar, closestPoint, maxPoint, fibonacciSphere, annulus){
     ...
     * rotateObj: null,
     * aimedStar: null,
     * setup: BuildSpace.setup,
     * setOperation: BuildSpace.setOperation,
     * zoom: BuildSpace.zoom,
     * click: BuildSpace.click
     * }}
     */
    BuildSpace.prototype = {
        ...
        /**
         * 初始化 space 界面
         * 所有 .star 根据最内层的个数分成若干个 section，每个 section 颜色不同
         * 每个 section 中的 .star 在空间球面表面上按照斐波那契螺旋均匀分布
         * @param confObj 参数对象，如下
         * {
         * stage:       stage element,
         * rotateObj:   rotate object element,
         * radius:      140,
         * gap:         120,
         * unit:        'px',
         * }
        ...
        setup : function (confObj) {
            ...
            (function init() {
                ...
                rotateObj = THIS.config.rotateObj;

                BuildSpace.prototype.stage     = stage;
                BuildSpace.prototype.rotateObj = rotateObj;
        ...
        zoom : function() {
            ...
            var stage = BuildSpace.prototype.stage,
                gap   = this.config.gap,
