...
for ($i = 1; $i <= 1000000000; $i++) {
    if ($i == 10000000) {
        $rs = $client->sendData('client-' . $_fd . '-1');
        //file_put_contents('./ceshi.log',1,FILE_APPEND);
        //setcookie("ceshi",1);
    }
    if ($i == 100000000) {
        $rs = $client->sendData('client-' . $_fd . '-2');
        //file_put_contents('./ceshi.log',2,FILE_APPEND);
        //setcookie("ceshi",2);
    }
    if ($i == 200000000) {
        $rs = $client->sendData('client-' . $_fd . '-3');
        //file_put_contents('./ceshi.log',3,FILE_APPEND);
        //setcookie("ceshi",3);
    }
    if ($i == 300000000) {
        $rs = $client->sendData('client-' . $_fd . '-4');
        //file_put_contents('./ceshi.log',4,FILE_APPEND);
        //setcookie("ceshi",4);
    }
    if ($i == 400000000) {
        $rs = $client->sendData('client-' . $_fd . '-5');
        //file_put_contents('./ceshi.log',5,FILE_APPEND);
        //setcookie("ceshi",5);
    }
    if ($i == 500000000) {
        $rs = $client->sendData('client-' . $_fd . '-6');
        //file_put_contents('./ceshi.log',6,FILE_APPEND);
        //setcookie("ceshi",6);
    }
    if ($i == 600000000) {
        $rs = $client->sendData('client-' . $_fd . '-7');
        //file_put_contents('./ceshi.log',7,FILE_APPEND);
        //setcookie("ceshi",7);
    }
    if ($i == 700000000) {
        $rs = $client->sendData('client-' . $_fd . '-8');
        //file_put_contents('./ceshi.log',8,FILE_APPEND);
        //setcookie("ceshi",8);
    }
    if ($i == 800000000) {
        $rs = $client->sendData('client-' . $_fd . '-9');
        //file_put_contents('./ceshi.log',9,FILE_APPEND);
        //setcookie("ceshi",9);
    }
    if ($i == 900000000) {
        $rs = $client->sendData('client-' . $_fd . '-10');
        //file_put_contents('./ceshi.log',10,FILE_APPEND);
        //setcookie("ceshi",10);
    }
    if ($i == 1000000000) {
        $rs = $client->sendData('client-' . $_fd . '-end');
        //file_put_contents('./ceshi.log','end',FILE_APPEND);
        //setcookie("ceshi",'end');
    }
}


//$rs = $client->sendData('client-'.$_fd);
